...
/*   Updated: 2025/04/02 19:19:06 by lmokhtar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool						process_heredoc_line(char *line, t_heredoc *heredoc,
								t_data *data, int pipefd[2]);
void						handle_heredoc_eof(void);
void						prepare_heredoc_redir(t_heredoc *heredoc,
								int pipefd[2]);
// heredoc parser
...
bool						process_heredoc_tok(t_cmd_list *cmd, t_token *token,
								t_data *data);
bool						process_all_heredocs(t_cmd_list *cmd,
